      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-[family-name:var(--font-display)] text-primary">Lush Moments</h3>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Creating unforgettable celebrations with elegant décor that brings your vision to life.
            </p>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Lush Moments. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
